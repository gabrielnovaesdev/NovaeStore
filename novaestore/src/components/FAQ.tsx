          ...
          return (
            <div
              ...
              className={`border rounded-2xl overflow-hidden transition-all duration-300 ${
                isOpen
                  ? 'bg-[#12121e] border-indigo-500/40 shadow-[0_4px_20px_rgba(0,0,0,0.4)]'
                  : 'bg-[#0f0f18] border-white/5 hover:border-white/10 hover:bg-[#12121c]'
              }`}
            >
              <button
                id={`faq-toggle-${idx}`}
              ...
              >
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-transform duration-300 ${
                    isOpen ? 'bg-indigo-600 text-white rotate-180' : 'bg-white/5 text-slate-400'
                  }`}
                >
              ...
              >
                <p className="text-slate-300 text-sm sm:text-base leading-relaxed border-t border-white/5 pt-4">
                  {faq.answer}
                </p>
              </div>
            </div>
