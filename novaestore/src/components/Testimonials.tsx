  ...
  return (
    <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      <div className="text-center max-w-2xl mx-auto mb-16">
        ...
        <div className="mt-4 inline-flex items-center gap-2 text-[11px] text-slate-500 bg-white/[0.03] px-3 py-1 rounded-md border border-white/5 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {testimonials.map((t) => (
          <div
            ...
            className="bg-[#11111a] border border-white/5 hover:border-indigo-500/30 rounded-3xl p-8 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between"
          >
            <div>
              {/* Star Rating */}
