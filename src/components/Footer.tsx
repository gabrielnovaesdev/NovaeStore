...
import { Gamepad2, Mail, ShieldCheck, Zap, Heart } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#060609] border-t border-white/5 pt-16 pb-12 text-slate-400 text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/5">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="inline-flex items-center gap-1.5 text-xs text-indigo-400 bg-indigo-500/10 px-3 py-1 rounded-full border border-indigo-500/20">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <p className="text-center md:text-right max-w-xl text-slate-400 leading-normal">
            Aviso Legal: Os nomes de jogos, marcas registradas e artes de capa são propriedades de seus respectivos detentores e desenvolvedores. Dados mockados preparados para integração com backend Antigravity.
          </p>
        </div>
      </div>
    </footer>
